...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'problem', 'assignment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.Assignment'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        db.delete_column(u'problem', 'assignment_id')
