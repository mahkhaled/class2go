...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.contest'
        db.add_column(u'c2g_assignment', 'contest',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['c2g.Contest'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.contest'
        db.delete_column(u'c2g_assignment', 'contest_id')
